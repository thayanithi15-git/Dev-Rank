...
const McpConnectivityIllustration: React.FC<McpConnectivityIllustrationProps> = ({ className = "" }) => {
  ...
  const integrations = [
    { name: "GitHub", icon: "/images/mcp-integrations/figma.svg", installed: true },
    { name: "LeetCode", icon: "/images/mcp-integrations/shadcn.svg", installed: true },
    { name: "Stack Overflow", icon: "/images/mcp-integrations/nextjs.svg" },
    { name: "HackerRank", icon: "/images/mcp-integrations/tailwind-css.svg", installed: true },
    { name: "CodeChef", icon: "/images/mcp-integrations/resend.svg" },
    { name: "Portfolio Sites", icon: "/images/mcp-integrations/react.svg", installed: true },
  ]
