  ...
  return (
    ...
    >
      ...
      <nav className="hidden lg:flex items-center gap-1 xl:gap-6">
        <a
          href="#"
          className="text-foreground/95 hover:text-white hover:font-semibold text-sm xl:text-base font-medium px-3 xl:px-4 py-2 rounded-full hover:bg-white/30 hover:backdrop-blur-sm transition-all duration-200 hover:shadow-lg"
        >
          Features
        </a>
        <a
      ...
      <div className="lg:hidden flex items-center gap-2 sm:gap-3 mobile-menu-container relative">
        ...
        {mobileMenuOpen && (
          <div className="absolute top-full right-0 mt-2 w-40 sm:w-44 md:w-48 rounded-xl bg-background/90 backdrop-blur-3xl shadow-2xl border border-white/20 flex flex-col z-50 animate-fade-in before:absolute before:inset-0 before:bg-gradient-to-b before:from-white/[0.05] before:to-white/[0.02] before:rounded-xl before:-z-10">
            <a
              href="#"
              className="px-4 sm:px-5 py-2.5 sm:py-3 text-foreground/95 hover:text-primary hover:bg-white/10 hover:backdrop-blur-sm rounded-t-xl text-sm sm:text-base font-medium transition-all duration-150"
            ...
            <a
              href="#"
              className="px-4 sm:px-5 py-2.5 sm:py-3 text-foreground/95 hover:text-primary hover:bg-white/10 hover:backdrop-blur-sm text-sm sm:text-base font-medium transition-all duration-150"
              onClick={() => setMobileMenuOpen(false)}
            >
              Pricing
            </a>
